...
storemax= 0.3 #proportion of structural mass that individuals can devote to energy storage
storemin = 0.1
...
#      
image.plot(1:Lmax, 1:Yindexmax, t(optU[,, 1,1]), breaks = c(-1.5, -0.5, seq(0.1,1, by=0.1)), col=gcol,  ylab="State", xlab="Length", main="growth")       

image.plot(1:Lmax, 1:Yindexmax, t(optR[,, 1,1]),breaks = c(-1.5, -0.5, seq(0.1,1, by=0.1)), col=gcol,  ylab="State", xlab="Length", main="reproduction")       

image.plot(1:Lmax, 1:Yindexmax, t(optU[,, 1,(Tmax-20)]), breaks = c(-1.5, -0.5, seq(0.1,1, by=0.1)), col=gcol,  ylab="State", xlab="Length", main="growth Tmax-20")       

image.plot(1:Lmax, 1:Yindexmax, t(optR[,, 1,(Tmax-20)]),breaks = c(-1.5, -0.5, seq(0.1,1, by=0.1)), col=gcol,  ylab="State", xlab="Length", main="reproduction Tmax-20")       
...
z<-  Jdensity*a*Lmax^3*initialsize^3*(storemax-0.05)/(Yindexmax^3) #fixed initial state
