...
test_length <- read.csv("01LengthTemp293c10Kappa2.65.csv")
test_repro <- read.csv("02ReproTemp293c10Kappa2.65.csv")
test_state <- read.csv("03StateTemp293c10Kappa2.65.csv")
